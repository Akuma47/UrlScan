...
def scanner():
    arquivo = open(wordlist, 'r')#Mudar para que coloque a wordlist depois de -w
...
#print(f'Enconding: {req.encoding}')
#print(f'Status code: {req.status_code}')
#print(f'req.elapsed {req.elapsed}')
#print(f'req.url  {req.url}')


#print(f'req.history {req.history}')
